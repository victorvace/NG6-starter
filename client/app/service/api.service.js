export default class Service {
    ...
    answers = [
        ...
        { type: 'afirmative', text: 'Te has deo cuenta tu también ¿no?...' },
        ...
        { type: 'negative', text: 'Nope :)' }
    ]

    getAnswer(){
        return this.answers[(Math.floor( Math.random() * this.answers.length ))].text;
    }
}
